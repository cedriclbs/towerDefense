...
public class WaveManagement {
    ...
    private void initWave(Difficulty difficulty) {
        ...
        if(difficulty== Jouer.Difficulty.FACILE){
            listeWaves.add(new Wave(new ArrayList<Integer>(Arrays.asList(2,2,2,2,2,2,2,2,2))));
            listeWaves.add(new Wave(new ArrayList<Integer>(Arrays.asList(2,2,2,2,0,2,2,0,2,1))));
        ...
        if(difficulty== Jouer.Difficulty.MOYEN){
            listeWaves.add(new Wave(new ArrayList<Integer>(Arrays.asList(2,2,2,2,2,2,2,2,2))));
            listeWaves.add(new Wave(new ArrayList<Integer>(Arrays.asList(2,2,2,2,0,2,2,0,2,1))));
            listeWaves.add(new Wave(new ArrayList<Integer>(Arrays.asList(0,2,1,3,2,1,2,3,2,1))));
        ...
        if(difficulty== Jouer.Difficulty.DIFFICILE){
            listeWaves.add(new Wave(new ArrayList<Integer>(Arrays.asList(2,2,2,2,2,2,2,2,3,1))));
            listeWaves.add(new Wave(new ArrayList<Integer>(Arrays.asList(2,2,2,1,2,2,2,0,2,1))));
            listeWaves.add(new Wave(new ArrayList<Integer>(Arrays.asList(2,1,1,2,3,1,2,0,1))));
            listeWaves.add(new Wave(new ArrayList<Integer>(Arrays.asList(2,2,getRndIntNull(),getRndIntNull(),getRndIntNull(),getRndIntNull(),getRndInt(),getRndIntNull(),getRndIntNull(),getRndInt()))));
            ...
            listeWaves.add(new Wave(new ArrayList<Integer>(Arrays.asList(getRndIntNull(),2,getRndInt(),getRndInt(),getRndIntNull(),getRndInt(),getRndInt(),getRndIntNull(),getRndInt(),getRndInt()))));
            ...
            listeWaves.add(new Wave(new ArrayList<Integer>(Arrays.asList(getRndIntNull(),getRndIntNull(),getRndIntNull(),getRndIntNull(),getRndIntNull(),getRndIntNull(),getRndInt(),getRndIntNull(),getRndIntNull(),getRndInt()))));
            listeWaves.add(new Wave(new ArrayList<Integer>(Arrays.asList(getRndIntNull(),getRndIntNull(),getRndIntNull(),getRndIntNull(),getRndIntNull(),getRndInt(),getRndIntNull(),getRndInt(),getRndIntNull(),getRndInt()))));
    ...
    public void update () {
        ...
        if (jouer.getCurrentDifficulty() == Jouer.Difficulty.MARATHON && besoinDePlusDeVagues()) {
            listeWaves.add(new Wave(new ArrayList<Integer>(Arrays.asList(2,2,1,getRndInt(),getRndInt(),getRndInt(),getRndInt(),getRndInt(),getRndInt(),getRndInt(),getRndIntNull(),getRndIntNull(),getRndInt()))));
        } 
    }
