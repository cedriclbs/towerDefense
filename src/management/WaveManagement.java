...
public class WaveManagement {
    ...
    private void initWave(Difficulty difficulty) {
        ...
        if(difficulty== Jouer.Difficulty.MOYEN){
            listeWaves.add(new Wave(new ArrayList<Integer>(Arrays.asList(2,2,2,2,2,2,2,2))));
            listeWaves.add(new Wave(new ArrayList<Integer>(Arrays.asList(2,2,2,2,0,2,2,1))));
            listeWaves.add(new Wave(new ArrayList<Integer>(Arrays.asList(0,2,1,3,2,1,2,2,1))));
        ...
        if(difficulty== Jouer.Difficulty.DIFFICILE){
            ...
            listeWaves.add(new Wave(new ArrayList<Integer>(Arrays.asList(2,2,getRndIntNull(),getRndIntNull(),getRndIntNull(),getRndInt(),getRndIntNull(),getRndIntNull()))));
