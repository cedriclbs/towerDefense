...
public class WaveManagement {
    ...
    private void initWave(Difficulty difficulty) {
        ...
        if(difficulty== Jouer.Difficulty.MOYEN){
            ...
            listeWaves.add(new Wave(new ArrayList<Integer>(Arrays.asList(0,2,getRndIntNull(),getRndIntNull(),getRndIntNull(),getRndInt(),getRndIntNull(),getRndInt(),getRndIntNull(),getRndInt()))));
